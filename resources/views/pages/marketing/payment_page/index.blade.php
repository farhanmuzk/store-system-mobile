<x-app-layout>
    ...
    @if ($latestNotification && $latestNotification->status === 'rejected')
        <div class="mt-4 flex justify-center">
            <div
                class="text-sm text-red-500 border border-red-500 bg-red-50 p-4 rounded-xl font-semibold text-center max-w-md w-full">
    ...
    @if (!$payment->cash_code && !$payment->transfer_payment)
